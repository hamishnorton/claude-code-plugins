...
Write-Host "This will install: Git, Pandoc, Claude Code, VS Code, and the Class Toolkit launcher"
Write-Host ""
...
# 1. Git for Windows
Write-Host ""
Write-Host "[1/5] Installing Git for Windows..." -ForegroundColor Yellow
...
# 2. Pandoc
Write-Host ""
Write-Host "[2/5] Installing Pandoc..." -ForegroundColor Yellow
...
# 3. Claude Code CLI
Write-Host ""
Write-Host "[3/5] Installing Claude Code..." -ForegroundColor Yellow
...
# 4. VS Code
Write-Host ""
Write-Host "[4/5] Installing VS Code..." -ForegroundColor Yellow
